...
async def index():
    ...
    response.headers[
        'Content-Security-Policy'] = "default-src 'self' https://giffe.s3.amazonaws.com/gifs/ https://giffe.s3.ap-south-1.amazonaws.com/share_buttons/ style-src 'self' 'unsafe-inline';"
